...
def set_env(env, prereq_dir, version):
    ...
    if platform.system() == "Windows" :
        ...
        env.prepend('DYLD_LIBRARY_PATH', os.path.join(prereq_dir, 'lib', pyver, 'site-packages', 'PySide2'))
        env.prepend('DYLD_LIBRARY_PATH', os.path.join(prereq_dir, 'lib', pyver, 'site-packages', 'shiboken2'))
